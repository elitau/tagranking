...
wobei $\lambda$ der Menge $[0,1]$ entspricht und später festgelegt wird. Dieser Parameter kontrolliert somit die Einflussnahme der einzelnen Ähnlichkeitswerte auf den resultierenden Gesamtwert $s_{ij}$.
